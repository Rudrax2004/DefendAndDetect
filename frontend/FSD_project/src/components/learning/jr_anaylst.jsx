...
export const JuniorDataSecurityAnalyst = () => {
    ...
    <>
      ...
      <div className="relative mt-8 container bg-black mx-auto group rounded-2xl overflow-hidden border-4 border-gray-500">
        ...
        <div className="bg-opacity-70 bg-gray-800 p-8">
          <h1 className="text-3xl font-bold text-yellow-600 mb-8">Junior Cybersecurity Analyst</h1>

            <AccordionBasicExample index={4}/>
        </div>
      </div>
      <Footer />
    </>
